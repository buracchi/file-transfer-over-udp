...
#include "tproto/tproto_service_udp.h"
...
#include "types/tproto/tproto_service_udp.h"
...
static struct cmn_tproto_service_udp service = {
    .super = {
    ...
    extern cmn_tproto_service_t cmn_tproto_service_udp = &(service.super);
#elif __unix__
    cmn_tproto_service_t cmn_tproto_service_udp = &(service.super);
#endif
