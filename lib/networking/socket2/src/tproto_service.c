...
extern inline int cmn_tproto_service_accept(cmn_tproto_service_t this, cmn_socket2_t socket, struct sockaddr* addr, socklen_t* addr_len) {
    return this->__ops_vptr->accept(this, socket, addr, addr_len);
}

extern inline int cmn_tproto_service_connect(cmn_tproto_service_t this, cmn_socket2_t socket, struct sockaddr* addr, socklen_t addr_len) {
