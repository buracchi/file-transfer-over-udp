...
extern int cmn_tproto_service_accept(cmn_tproto_service_t service, cmn_socket2_t socket, struct sockaddr* addr, socklen_t* addr_len);

extern int cmn_tproto_service_connect(cmn_tproto_service_t service, cmn_socket2_t socket, struct sockaddr* addr, socklen_t addr_len);
